...
void Robot::RobotInit() {
	...
	double P = prefs->GetDouble("P: ", 5.0);
	double I = prefs->GetDouble("I: ", 0.5);
	double D = prefs->GetDouble("D: ", driveTrain->kD);
	...
	frc::SmartDashboard::PutString("Camera", "Camera Is On");
...
void Robot::AutonomousInit() {
	...
	//autonomousCommand.reset(new DriveForDistance(10, 0)); //In meters, angle
	//autonomousCommand->Start();
	autonomousCommand.reset(new TurnDegrees(90)); //In meters, angle
	autonomousCommand->Start();
}
